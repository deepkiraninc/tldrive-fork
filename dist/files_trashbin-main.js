...
const defaultDavProperties = ['d:getcontentlength', 'd:getcontenttype', 'd:getetag', 'd:getlastmodified', 'd:quota-available-bytes', 'd:resourcetype', 'nc:has-preview', 'nc:is-encrypted', 'nc:mount-type', 'nc:share-attributes', 'oc:comments-unread', 'oc:favorite', 'oc:fileid', 'oc:owner-display-name', 'oc:owner-id', 'oc:permissions', 'oc:share-types', 'oc:size', 'ocs:share-permissions'];
 ...
 * @param namespace
 */
const registerDavProperty = function (prop) {
  ...
  if (window._nc_dav_properties.find(search => search === prop)) {
    _logger__WEBPACK_IMPORTED_MODULE_0__["default"].error("".concat(prop, " already registered"), {
      prop
    });
    return;
  }
  if (prop.startsWith('<') || prop.split(':').length !== 2) {
    _logger__WEBPACK_IMPORTED_MODULE_0__["default"].error("".concat(prop, " is not valid. See example: 'oc:fileid'"), {
      prop
    });
    return;
  }
  ...
  if (!namespaces[ns]) {
    _logger__WEBPACK_IMPORTED_MODULE_0__["default"].error("".concat(prop, " namespace unknown"), {
      prop,
      namespaces
    });
    return;
...
const getDavNameSpaces = function () {
  ...
  return Object.keys(window._nc_dav_namespaces).map(ns => "xmlns:".concat(ns, "=\"").concat(window._nc_dav_namespaces[ns], "\"")).join(' ');
};
/**
...
/* harmony import */ var _files_src_services_FileAction__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../files/src/services/FileAction */ "./apps/files/src/services/FileAction.ts");
/* harmony import */ var _files_src_logger_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../files/src/logger.js */ "./apps/files/src/logger.js");
/**
 * @copyright Copyright (c) 2023 John Molakvoæ <skjnldsv@protonmail.com>
 *
 * @author John Molakvoæ <skjnldsv@protonmail.com>
...
(0,_files_src_services_FileAction__WEBPACK_IMPORTED_MODULE_7__.registerFileAction)(new _files_src_services_FileAction__WEBPACK_IMPORTED_MODULE_7__.FileAction({
  id: 'restore',
  displayName() {
  ...
  async exec(node) {
    try {
      var _getCurrentUser;
      const destination = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateRemoteUrl)("dav/trashbin/".concat((_getCurrentUser = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_2__.getCurrentUser)()) === null || _getCurrentUser === void 0 ? void 0 : _getCurrentUser.uid, "/restore/").concat(node.basename));
      ...
      _files_src_logger_js__WEBPACK_IMPORTED_MODULE_8__["default"].error(error);
      return false;
    }
  },
...
Navigation.register({
  ...
  columns: [{
    ...
    render(node) {
      ...
      const deletionTime = (_node$attributes = node.attributes) === null || _node$attributes === void 0 ? void 0 : _node$attributes['trashbin-deletion-time'];
...
/* harmony import */ var _files_src_services_DavProperties__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../files/src/services/DavProperties */ "./apps/files/src/services/DavProperties.ts");
/* harmony import */ var _client__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./client */ "./apps/files_trashbin/src/services/client.ts");
/**
 * @copyright Copyright (c) 2023 John Molakvoæ <skjnldsv@protonmail.com>
 *
 * @author John Molakvoæ <skjnldsv@protonmail.com>
...
const data = "<?xml version=\"1.0\"?>\n<d:propfind ".concat((0,_files_src_services_DavProperties__WEBPACK_IMPORTED_MODULE_3__.getDavNameSpaces)(), ">\n\t<d:prop>\n\t\t<nc:trashbin-filename />\n\t\t<nc:trashbin-deletion-time />\n\t\t<nc:trashbin-original-location />\n\t\t<nc:trashbin-title />\n\t\t").concat((0,_files_src_services_DavProperties__WEBPACK_IMPORTED_MODULE_3__.getDavProperties)(), "\n\t</d:prop>\n</d:propfind>");
const resultToNode = function (node) {
  var _node$props, _getCurrentUser, _node$props2, _node$props3, _node$props4;
  const permissions = (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.parseWebdavPermissions)((_node$props = node.props) === null || _node$props === void 0 ? void 0 : _node$props.permissions);
  const owner = (_getCurrentUser = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)()) === null || _getCurrentUser === void 0 ? void 0 : _getCurrentUser.uid;
  const previewUrl = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateUrl)('/apps/files_trashbin/preview?fileId={fileid}&x=32&y=32', node.props);
  const nodeData = {
    id: ((_node$props2 = node.props) === null || _node$props2 === void 0 ? void 0 : _node$props2.fileid) || 0,
    source: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateRemoteUrl)('dav' + _client__WEBPACK_IMPORTED_MODULE_4__.rootPath + node.filename),
    ...
    permissions,
    owner,
    root: _client__WEBPACK_IMPORTED_MODULE_4__.rootPath,
    attributes: {
      ...node,
      ...node.props,
...
const getContents = async function () {
  ...
  const rootResponse = await _client__WEBPACK_IMPORTED_MODULE_4__["default"].stat(path, {
    details: true,
    data
  });
  const contentsResponse = await _client__WEBPACK_IMPORTED_MODULE_4__["default"].getDirectoryContents(path, {
    details: true,
    data
  });
  return {
...
/******/ })()
;
//# sourceMappingURL=files_trashbin-main.js.map?v=97f517853213507591ea