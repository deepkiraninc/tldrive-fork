...
// Dynamic loading
const Users = () => Promise.all(/*! import() | settings-users */[__webpack_require__.e("core-common"), __webpack_require__.e("node_modules_nextcloud_vue_dist_Components_NcContent_js-node_modules_nextcloud_vue_dist_Compo-d75b4a"), __webpack_require__.e("settings-users")]).then(__webpack_require__.bind(__webpack_require__, /*! ./views/Users.vue */ "./apps/settings/src/views/Users.vue"));
const Apps = () => Promise.all(/*! import() | settings-apps-view */[__webpack_require__.e("core-common"), __webpack_require__.e("node_modules_nextcloud_vue_dist_Components_NcContent_js-node_modules_nextcloud_vue_dist_Compo-d75b4a"), __webpack_require__.e("settings-apps-view")]).then(__webpack_require__.bind(__webpack_require__, /*! ./views/Apps.vue */ "./apps/settings/src/views/Apps.vue"));
...
const actions = {
   ...
   * @return {Promise}
   */
  getUsersFromList(context, _ref17) {
    let {
      offset,
      limit,
      search
   ...
   * @return {Promise}
   */
  getUsersFromGroup(context, _ref18) {
    let {
      groupid,
      offset,
      limit
   ...
   * @return {Promise}
   */
  removeUserGroup(context, _ref21) {
    let {
      userid,
      gid
    } = _ref21;
   ...
   * @return {Promise}
   */
  addUserSubAdmin(context, _ref22) {
    let {
      userid,
      gid
    } = _ref22;
   ...
   * @return {Promise}
   */
  removeUserSubAdmin(context, _ref23) {
    let {
      userid,
      gid
    } = _ref23;
   ...
   * @return {Promise}
   */
  enableDisableUser(context, _ref26) {
    let {
      userid,
      enabled = true
    } = _ref26;
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"node_modules_nextcloud_vue_dist_Components_NcContent_js-node_modules_nextcloud_vue_dist_Compo-d75b4a":"f0a2b3a5c19a437f949c","settings-users":"81f1251e663713ff048d","settings-apps-view":"75ddeab20cbf6daa32c9"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-apps-users-management.js.map?v=d671433c297098a7c5e6