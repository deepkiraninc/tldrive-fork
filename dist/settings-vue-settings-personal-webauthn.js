...
/* harmony import */ var _service_WebAuthnRegistrationSerice_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../service/WebAuthnRegistrationSerice.js */ "./apps/settings/src/service/WebAuthnRegistrationSerice.js");
...
const logAndPass = text => data => {
  _logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].debug(text);
  return data;
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    start() {
      ...
      return (0,_nextcloud_password_confirmation__WEBPACK_IMPORTED_MODULE_0__.confirmPassword)().then(this.getRegistrationData).then(this.register.bind(this)).then(() => {
    ...
    getRegistrationData() {
      ...
      return (0,_service_WebAuthnRegistrationSerice_js__WEBPACK_IMPORTED_MODULE_3__.startRegistration)().then(publicKey => {
    ...
    submit() {
      ...
      return (0,_nextcloud_password_confirmation__WEBPACK_IMPORTED_MODULE_0__.confirmPassword)().then(logAndPass('confirmed password')).then(this.saveRegistrationData).then(logAndPass('registration data saved')).then(() => this.reset()).then(logAndPass('app reset')).catch(console.error.bind(this));
    },
    async saveRegistrationData() {
      try {
        const device = await (0,_service_WebAuthnRegistrationSerice_js__WEBPACK_IMPORTED_MODULE_3__.finishRegistration)(this.name, JSON.stringify(this.credential));
        _logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].info('new device added', {
          device
        });
        this.$emit('added', device);
      } catch (err) {
        _logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].error('Error persisting webauthn registration', {
          error: err
        });
...
/* harmony import */ var _AddDevice_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AddDevice.vue */ "./apps/settings/src/components/WebAuthn/AddDevice.vue");
/* harmony import */ var _Device_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Device.vue */ "./apps/settings/src/components/WebAuthn/Device.vue");
/* harmony import */ var _logger_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../logger.js */ "./apps/settings/src/logger.js");
/* harmony import */ var _service_WebAuthnRegistrationSerice_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../service/WebAuthnRegistrationSerice.js */ "./apps/settings/src/service/WebAuthnRegistrationSerice.js");
...
const sortByName = lodash_fp_sortBy_js__WEBPACK_IMPORTED_MODULE_2___default()('name');
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    AddDevice: _AddDevice_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    Device: _Device_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
  },
  props: {
    initialDevices: {
      type: Array,
  ...
  methods: {
    deviceAdded(device) {
      _logger_js__WEBPACK_IMPORTED_MODULE_5__["default"].debug("adding new device to the list ".concat(device.id));
      this.devices.push(device);
    },
    async deleteDevice(id) {
      _logger_js__WEBPACK_IMPORTED_MODULE_5__["default"].info("deleting webauthn device ".concat(id));
      await (0,_nextcloud_password_confirmation__WEBPACK_IMPORTED_MODULE_0__.confirmPassword)();
      await (0,_service_WebAuthnRegistrationSerice_js__WEBPACK_IMPORTED_MODULE_6__.removeRegistration)(id);
      this.devices = this.devices.filter(d => d.id !== id);
      _logger_js__WEBPACK_IMPORTED_MODULE_5__["default"].info("webauthn device ".concat(id, " removed successfully"));
    }
  }
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AddDevice_vue_vue_type_template_id_15f8a53b_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AddDevice_vue_vue_type_template_id_15f8a53b_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Device_vue_vue_type_template_id_1b250cbc_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Device_vue_vue_type_template_id_1b250cbc_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Section_vue_vue_type_template_id_47c82c6e_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Section_vue_vue_type_template_id_47c82c6e_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-personal-webauthn.js.map?v=9d0482b210549adf6ee0